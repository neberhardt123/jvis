...
def create_topology():
    ...
    styles = {
        ...
        "comp": "verticalLabelPosition=bottom;align=center;html=1;shape=mxgraph.gcp2.cloud_computer;aspect=fixed;whiteSpace=wrap;fillColor=#3B8DF1;",
    ...
    config = [  'label: %name%',
                #'style: shape=%shape%;fillColor=%fill%;strokeColor=%stroke%;fontSize=%fontSize%;fontColor=%font%;aspect=fixed;%type%;image=%image%;align=center;whiteSpace=wrap;html=1',
                'parentstyle: swimlane;fontStyle=1;childLayout=stackLayout;horizontal=1;startSize=35;fillColor=#3f7de0;horizontalStack=1;resizeParent=0;resizeChildren=0;collapsible=0;fontColor=#ffffff;fontSize=12;whiteSpace=wrap;html=1',
                'stylename: cat',
